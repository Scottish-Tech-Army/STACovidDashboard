Modified version of chartjs-plugin-annotation.js to allow label position adjustment to avoid going out of chart bounds. If the modification gets included and released in the official plugin, this variant can be removed.

Original plugin README.md below and LICENSE.md included in directory
