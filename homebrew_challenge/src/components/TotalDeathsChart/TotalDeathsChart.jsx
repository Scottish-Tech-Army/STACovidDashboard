...
WHERE {
   VALUES (?value ?shortValue) {
    ( <http://statistics.gov.scot/def/concept/variable/number-of-covid-19-confirmed-deaths-registered-to-date> "total" )
  }
...
const TotalDeathsChart = () => {
  ...
  const datasetLabel = "Total Deaths";
